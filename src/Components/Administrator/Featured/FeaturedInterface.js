...
import {useStyles} from "./FeaturedInterfaceCss"
...
export default function FeaturedInterface(props){
  ...
  var response=await postData('feature/featuresubmit',formData)  //from this line it will jump to the const postData in FetchNodeServices.js file 
  if(response.status)
    {
    Swal.fire({
        icon: "success",
